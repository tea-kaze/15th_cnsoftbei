...
| **CSS 2D 数字人** | 古风汉服头像，3 种表情 + 口型动画，零外部依赖 |
...
| **数字人配置** | VTube Studio 连接管理、表情/动作测试面板 |
...
| 数字人 | CSS 2D + VTube Studio | CSS 保底可用，VTS 3D 增强 |
